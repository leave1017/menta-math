  ...
  return (
    <div className="space-y-8">
          ...
          {GRADES_DATA.map((grade) => (
            ...
            >
              <div className="flex items-center justify-between mb-3">
                <div className="text-2xl font-bold text-slate-900 dark:text-slate-100 group-hover:text-emerald-600 dark:group-hover:text-emerald-400">
                  Grade {grade.grade}
                </div>
        ...
        <div className="rounded-xl border border-slate-200 dark:border-slate-700 bg-white dark:bg-slate-800 overflow-hidden shadow-sm">
          <table className="w-full text-sm">
            <thead className="bg-slate-50 dark:bg-slate-700">
              <tr>
                <th className="px-4 py-3 text-left font-semibold text-slate-900 dark:text-slate-100">US Grade</th>
                <th className="px-4 py-3 text-left font-semibold text-slate-900 dark:text-slate-100">UK Year</th>
                <th className="px-4 py-3 text-left font-semibold text-slate-900 dark:text-slate-100">Age</th>
                <th className="px-4 py-3 text-left font-semibold text-slate-900 dark:text-slate-100">Key Focus</th>
              </tr>
            </thead>
            <tbody className="divide-y">
              <tr className="hover:bg-slate-50 dark:hover:bg-slate-700">
                ...
                <td className="px-4 py-3 text-slate-600 dark:text-slate-400">Number bonds, addition/subtraction within 20</td>
              </tr>
              <tr className="hover:bg-slate-50 dark:hover:bg-slate-700">
                <td className="px-4 py-3">Grade 2</td>
                <td className="px-4 py-3">Year 2</td>
                <td className="px-4 py-3">6-7</td>
                <td className="px-4 py-3 text-slate-600 dark:text-slate-400">2-digit operations, 2/5/10 times tables</td>
              </tr>
              <tr className="hover:bg-slate-50 dark:hover:bg-slate-700">
                <td className="px-4 py-3">Grade 3</td>
                <td className="px-4 py-3">Year 3</td>
                <td className="px-4 py-3">7-8</td>
                <td className="px-4 py-3 text-slate-600 dark:text-slate-400">3/4/8 times tables, 3-digit operations</td>
              </tr>
              <tr className="hover:bg-slate-50 dark:hover:bg-slate-700">
                <td className="px-4 py-3">Grade 4</td>
                <td className="px-4 py-3">Year 4</td>
                <td className="px-4 py-3">8-9</td>
                <td className="px-4 py-3 text-slate-600 dark:text-slate-400">All times tables to 12×12 (UK MTC year)</td>
              </tr>
              <tr className="hover:bg-slate-50 dark:hover:bg-slate-700">
                <td className="px-4 py-3">Grade 5</td>
                <td className="px-4 py-3">Year 5</td>
                <td className="px-4 py-3">9-10</td>
                <td className="px-4 py-3 text-slate-600 dark:text-slate-400">Multi-digit multiplication, decimals</td>
              </tr>
              <tr className="hover:bg-slate-50 dark:hover:bg-slate-700">
                <td className="px-4 py-3">Grade 6</td>
                <td className="px-4 py-3">Year 6</td>
                <td className="px-4 py-3">10-11</td>
                <td className="px-4 py-3 text-slate-600 dark:text-slate-400">Division, percentages, SATs preparation</td>
              </tr>
            </tbody>
          </table>
        </div>
      ...
      <section className="max-w-4xl">
        ...
        <div className="rounded-xl border border-slate-200 dark:border-slate-700 bg-gradient-to-br from-blue-50 to-white dark:from-blue-900/20 dark:to-slate-800 p-6 shadow-sm">
