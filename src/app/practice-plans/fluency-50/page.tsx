  ...
  return (
    <div className="max-w-4xl mx-auto space-y-10 py-8">
      ...
      <section className="rounded-xl border border-slate-200 bg-slate-50 p-4 shadow-sm">
        <h2 className="text-lg font-bold mb-3 text-purple-900">Plan Details</h2>
        <div className="grid md:grid-cols-3 gap-4 text-sm">
          <div>
            <h3 className="font-semibold text-slate-900 mb-1">Goal</h3>
            <p className="text-slate-700">Stable accuracy throughout</p>
          </div>
          <div>
            <h3 className="font-semibold text-slate-900 mb-1">Best For</h3>
            <p className="text-slate-700">Mixed review, classroom drills</p>
          </div>
          <div>
            <h3 className="font-semibold text-slate-900 mb-1">Tip</h3>
            <p className="text-slate-700">Drop to Speed 20 if accuracy falls</p>
          </div>
        </div>
      </section>
      ...
      <InlinePractice
        ...
        count={50}
        plan="fluency50"
        buttonText="Start 50-question set"
        buttonColor="inline-flex items-center gap-2 px-8 py-4 text-lg font-bold text-white bg-gradient-to-r from-purple-600 to-indigo-600 rounded-xl shadow-lg hover:shadow-xl hover:scale-105 transition-all"
        defaultNote="2-digit addition · You can adjust settings in the practice module"
      />
